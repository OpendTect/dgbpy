...
if is_version_3():
    ...
    from bokeh.models import Select, Tabs, CheckboxGroup, Slider, RadioGroup, Button, MultiSelect, RangeSlider, TextInput
else:
    from bokeh.models.widgets import Panel as TabPanel
    from bokeh.models.widgets import Select, Tabs, CheckboxGroup, Slider, RadioGroup, Button, MultiSelect, RangeSlider, TextInput
